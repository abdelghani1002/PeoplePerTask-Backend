...
<body class="overflow-x-hidden">
    ...
    <div class="flex flex-row justify-start">
        ...
        <div class="lg:w-72 sm:h-full h-screen">
            ...
            <!-- side bar -->
            <div id="sidebar"
                class=" z-50 fixed top-0 left-0 z-40 w-72 sm:h-full h-screen transition-transform -translate-x-full lg:translate-x-0"
                aria-label="Sidebar">
        ...
        <section class="flex-grow lg:w-9/12 flex flex-col gap-14 px-5">
           <h1 class="font-bold text-4xl text-center">Users Management</h1>
           <div class="flex flex-col text-xs   items-center  border-2 pb-5">
            <ul class="flex bg-slate-500 items-center text-xs sm:text-lg text-white font-bold w-full py-3">
            ...
            <ul class=" user flex  text-sm items-center text-xs sm:text-lg w-full py-3">
                <li class="w-2/5 text-center items-center flex gap-1 pl-2">
                ...
                <li class="w-1/6 text-center flex justify-around"><button  class="text-blue-500 edit_btn">EDIT</button> <button class="text-red-500 dele_btn">DELE</button></li>
