...
<body class="bg-gray-100 h-100 flex flex-col">
    ...
    <div class="w-1/3 m-auto h-100 mt-10">
        ...
        <form class="text-gray-900 border bg-gray-400 py-2 rounded-xl flex flex-col flex-grow w-100"
            ...
            <input class="py-2 px-1 m-3 w-100 bg-gray-200 placeholder:text-gray-600 rounded-md" type="text" name="name" id="name" placeholder="Title" value="<?= $skill['name'] ?>" required>
                        ...
                        <optgroup label="<?= $category_name ?>">
                            ...
                            ?>
                                <option class="bg-gray-200 text-gray-800" 
                                    ...
                                    <?php if($subcategory_id == $skill['subcategory_id']) echo'selected'; ?>
                                    >
                                    <?= $subcategory_name ?>
                                </option>
                            <?php
            ...
            <input class="text-white py-2 px-1 mt-3 w-100 bg-blue-500 hover:bg-blue-600 cursor-pointer rounded-md w-2/3 m-auto " type="submit" name="btn" id="btn" value="Update Skill">
        </form>
