...
<body class="overflow-x-hidden bg-slate-100 dark:bg-slate-900">
  ...
  <header class="flex bg-gray-50 justify-between p-2 md:py-3 md:px-8 lg:px-10 dark:bg-slate-800">
    ...
    <nav id="navbar"
      class="z-50 lg:items-center self-center flex flex-col gap-32 lg:flex-row lg:p-0  px-2 pb-8 w-3/6 sm:w-1/3 lg:static absolute lg:bg-transparent bg-gray-50 top-16 right-0  lg:w-9/12  lg:justify-end">
