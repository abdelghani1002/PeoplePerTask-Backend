...
<aside id="sidebar" class="w-1/6 min-h-full" aria-label="Sidebar">
    <div class="h-full px-1 py-4 overflow-y-auto flex flex-col justify-between bg-custom-green dark:bg-gray-800">
        <ul class="flex flex-col gap-1 font-medium">
            ...
            <!-- clients -->
            <li>
                <a href="<?= $path . "/src/client/index.php"?>" class="clients flex items-center py-2 pr-1 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            ...
            <!-- Skills -->
            <li>
                <a href="<?= $path . "/src/skill/index.php" ?>" class="skills flex items-center py-2 pr-1 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            ...
            <!-- Tags -->
            <li>
                <a href="<?= $path . "/src/tag/index.php" ?>" class="tags flex items-center py-2 pr-1 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
